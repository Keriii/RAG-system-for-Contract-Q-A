        ...
        <section className="mx-auto">
            <div className="max-w-7xl sm:p-8 px-4 py-8 m-auto hero">
                <div className="hero__text"> <br />
                    <h1 className="text-text">Lizzy Contract Advisor</h1>
                    <p className="mt-2 text-text max-w-[520px]">
                        Meet Lizzy, your best contract advisor. Just upload your contract and start asking question.
                    </p>

                    <p className="mt-2 text-text max-w-[500px]">
                    Click on the 'Ask Lizzy' button to get started.
                    </p>
                    <br />
                    <Link
                        to="/create"
                ...
                <div className="hero__img">
                    <img src={hero} alt="img" style={{ width: "100%", height: "auto", maxHeight: "300px" }} />
                </div>
            </div>
        </section>
    );
